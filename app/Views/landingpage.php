...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">Bita Merchandise</a>
            <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse"
                data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false"
                aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger p-3" href="#about">Tentang</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger p-3" href="#services">Layanan</a></li>
                    ...
                    <a href="/produk" class="nav-link bg-primary btn-xl p-3">Cek Pesanan Anda</a>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-10 align-self-end">
                    <h1 class="text-uppercase text-white font-weight-bold">Selamat Datang Di Website Bita Merchandise
                    </h1>
    ...
    <!-- Services-->
    <section class="page-section mb-2" id="services">
        <div class="container">
            <h2 class="text-center mt-0">Menyediakan Layanan</h2>
            <hr class="divider my-4" />
            <div class="row">
            ...
            <div class="row no-gutters" id="kategori-container">
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box">
                        <img class="img-fluid" src="/image/Hangtag.jpg" alt="" />
