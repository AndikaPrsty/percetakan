...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="/">Bita Merchandise</a>
    ...
    <?= $this->include('templates/about') ?>
    <?= $this->include('templates/service') ?>
    <!-- Portfolio-->
    <?= $this->renderSection('content') ?>
    <?= $this->include('templates/contact') ?>
    <!-- Footer-->
